...
fits_file_path = "/Users/Lillie/Desktop/Research Summer 2023/UltraThin.Galaxies/NGC6753_mom0.fits"
...
ax.contourf(array_axis1, array_axis2, data_image,levels=np.linspace(0,1,10)*np.nanmax(data_image))
plt.show()